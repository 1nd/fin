...
TBD — captures the runnable, responsive web application shell: layout across viewports, navigation, theming via semantic tokens, localization of all UI text, and the persistent local storage foundation.
